...
const NAV = [
  ...
  { icon: <AlertTriangle size={15} />, label: "Critical Alerts", path: "/admin/alerts" },
  { icon: <MapPin size={15} />, label: "Geographic Analysis", path: "/admin/geo" },
  { icon: <BarChart3 size={15} />, label: "Reports", path: "/admin/reports" },
  { icon: <Shield size={15} />, label: "Audit & Security", path: "/admin/security" },
  { icon: <BookOpen size={15} />, label: "Support Allocation", path: "/admin/support" },
