...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm text-slate-600">
            {["Home", "About RAAHAT", "How It Works", "Support Services", "Help"].map(l => (
              <a key={l} href="#" className="hover:text-navy-900 font-medium">{l}</a>
            ))}
            ...
            <div className="flex items-center gap-1.5 cursor-pointer" title="Accessibility">
      ...
      {/* Hero */}
      <section className="bg-navy-950 text-white py-20 px-6">
      ...
      {/* Privacy Notice */}
      <section className="py-8 px-6 bg-navy-50 border-b border-navy-100">
